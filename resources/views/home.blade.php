                ...
                <div class="row g-1 align-items-center">
                    ...
                    <div class="col-auto">
                        <button id='btnsave' class='btn btn-light'><i class="fa-regular fa-circle-check"></i>
                            save</button>
                        <button id='btncancel' class='btn btn-light'><i class="fa-solid fa-ban"></i> cancel</button>
                    </div>
                </div>
            </form>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('users.delete', $item->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus item ini?');">
                            @csrf
                            @method('DELETE')
